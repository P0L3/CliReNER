...
MODEL="EXPERIMENTS/models/GLINER_CUSTOM/clirebert_clirevocab_uncased_6estage1/stage1_s301202/GLiNER_CliReBERT_6es1_0es2"
DATA="P0L3/CliReNER_v_1_1_28_SILVER"
CONFIG="EXPERIMENTS/gliner_config.json"
PROJECT="CLIRENER_SILVER_SEEDS"
BASE_NAME="GLiNER_CliReBERT_6es1_0es2"
