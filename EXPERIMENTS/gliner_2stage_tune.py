...
BACKBONE_MODEL = "P0L3/clirebert_clirevocab_uncased" # "P0L3/cliscibert_scivocab_uncased" #    # only used for Stage 1 cold start
RUN_NAME = "clirebert_clirevocab_uncased_6estage1_12stage2"                                   # None -> shorten_name(BACKBONE_MODEL)
